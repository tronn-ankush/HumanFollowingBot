// ANKUSH TALUKDAR
//Human Follower Bot(Club Orientation)
...
#define RIGHT A2              // Right IR sensor connected to analog pin A2
#define LEFT A3               // Left IR sensor connected to analog pin A3
...
unsigned int distance = 0;    //Variable to store ultrasonic sensor value:
